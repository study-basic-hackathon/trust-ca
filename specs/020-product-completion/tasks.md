...
- [x] T032 frontend: 出品ウィザード(4step: カード情報→画像→検証(PSA/Vision分岐)→確認)
- [x] T033 frontend: 商品一覧(検索/フィルタ)・商品詳細(信頼シグナル個別表示)
- [x] T034 テスト: listings service/route(承認なし拒否・limits超過・Cert重複409・状態遷移)
